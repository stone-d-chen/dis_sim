...
birth_theta <- function(input) {
  ...
  theta_star <- sort(c(theta, theta_m))n
...
ops = c(death_theta,
        ...
        flip_edge)
lapply(ops, undebug)
undebug(update_edge_c)
undebug(flip_edge)
#undebug(increment_edge_c)
...
init_list <- list("1" = NULL, "2" = NULL, "3" = NULL)
...
# plot(res$count[-(1:burnin)], type = "l")
```
