...
par(mar = c(4,4,1,2), oma = c(4,0,3,0), mgp = c(3,1,0))
...
title(expression(paste(lambda, " Trace Plots for K = 2")), outer = TRUE)
mtext(text="Iteration", side = 1, line = 2, outer = TRUE)
```
